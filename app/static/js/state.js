...
export function showView(view) {
  state.view = view;
  for (const v of ["home", "builder", "dashboard", "editor", "portal", "modelling", "modelform", "bundleform", "lineage", "account", "chat", "notebook", "composer", "sandbox"]) {
  ...
  const mode = view === "portal" || (view === "dashboard" && state.portal) ? "portal"
    ...
    : view === "home" || view === "notebook" || view === "composer" ? "home" : "studio";
